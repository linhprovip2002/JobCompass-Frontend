    ...
    return (
        ...
        >
            <div className="space-y-6">
                {jobs.map((job, index) => (
                        <div key={index} className="flex items-center justify-between p-8 rounded-xl border border-gray-100 ">
                            <div className="flex items-center gap-5">
                                ...
                                <div className='space-y-3'>
                                    <h3 className="font-semibold text-xl flex items-center gap-2">{job.title} <Badge className='bg-primary-100 text-primary border-none rounded-xl px-4 shadow-none'>{job.type}</Badge></h3>
                            ...
                            <Button className='group' variant='secondary' size='xl'>Apply Now  <LuArrowRight className="group-hover:translate-x-2 transition-all" /></Button>
                        </div>
                ))}
            </div>
        </HomePart>
